...
public class AnthropicChatRequestValidatorTests
{
    private readonly AnthropicChatRequestValidator _validator;
    private readonly Mock<ILogger> _loggerMock;

    public AnthropicChatRequestValidatorTests()
    {
        _validator = new AnthropicChatRequestValidator();
    ...
    public void Validate_WhenResponseFormatIsProvided_LogsWarning()
    {
        ...
        _loggerMock.Verify(l => l.Log(
            LogLevel.Warning,
            It.IsAny<EventId>(),
            It.Is<It.IsAnyType>((v, t) => v.ToString()!.Contains("Anthropic does not support ResponseFormat")),
            null,
    ...
    public void Validate_WhenSeedIsProvided_LogsWarning()
    {
        ...
        _loggerMock.Verify(l => l.Log(
            LogLevel.Warning,
            It.IsAny<EventId>(),
            It.Is<It.IsAnyType>((v, t) => v.ToString()!.Contains("Anthropic does not support Seed")),
            null,
            It.IsAny<Func<It.IsAnyType, Exception?, string>>()),
            Times.Once);
    }
    ...
    public void Validate_WhenRequestIsValid_LogsInformation()
    {
        ...
        _loggerMock.Verify(l => l.Log(
            ...
            It.IsAny<EventId>(),
            It.Is<It.IsAnyType>((v, t) => v.ToString()!.Contains("Anthropic chat request validated successfully")),
            null,
            It.IsAny<Func<It.IsAnyType, Exception?, string>>()),
            Times.Once);
    }
    ...
    public void Validate_WhenBaseValidationFails_ThrowsArgumentException_BeforeProviderSpecificValidation()
    {
        ...
        _loggerMock.Verify(l => l.Log(
            LogLevel.Warning,
            It.IsAny<EventId>(),
            It.Is<It.IsAnyType>((v, t) => v.ToString()!.Contains("Anthropic does not support")),
            null,
            It.IsAny<Func<It.IsAnyType, Exception?, string>>()),
            Times.Never);
    }
